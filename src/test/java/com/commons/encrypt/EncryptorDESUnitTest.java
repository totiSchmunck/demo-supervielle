...
public class EncryptorDESUnitTest extends AbstractEncryptorUnitTest{
	
	private static String DES_PASSWORD = "Uk©WÝ;[\n%ÛìÈD";
	
	@Before
	public void setUp(){
		encryptor = EncryptorFactory.getEncryptor(EncryptionType.DES);
	}
